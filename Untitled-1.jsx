...
// ------------------------------handle XML
   ...
   //data.D2i_PreviousExchangeItem = convertToIndustryString(D2YouthInternshipExchangeHistoryFieldListDATA[0].D2i_PreviousExchangeItem, i_hk);
    //data.registrationstatus = convertToIndustryString(get(data, 'registrationstatus'), i_hk);
    ...
    if (!isEmpty(data.joinTwo)) {
      if (data.joinTwo == 'y') {
        data.joinTwo = i18n`field.label.partA.y`;
      } else if (data.joinTwo == 'n') {
        data.joinTwo = i18n`field.label.partA.n`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserOne_practiceItemTwo)) {
      if (data.registrationStatus_organiserOne_practiceItemTwo == 'option1') {
        data.registrationStatus_organiserOne_practiceItemTwo = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserOne_practiceItemTwo == 'option2') {
        data.registrationStatus_organiserOne_practiceItemTwo = `${i18n`field.label.partA.registrationOption2Part1`}${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserOne_practiceItemTwo == 'option3') {
        data.registrationStatus_organiserOne_practiceItemTwo = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserOne_practiceItemTwo == 'option4') {
        data.registrationStatus_organiserOne_practiceItemTwo = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join1_practiceItemTwo)) {
      if (data.registrationType_join1_practiceItemTwo == 'cbo1_a') {
        data.registrationType_join1_practiceItemTwo = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join1_practiceItemTwo == 'cbo1_b') {
        data.registrationType_join1_practiceItemTwo = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join1_practiceItemTwo == 'cbo1_c') {
        data.registrationType_join1_practiceItemTwo = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join1_practiceItemTwo == 'cbo1_d') {
        data.registrationType_join1_practiceItemTwo = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_d_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join1_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserTwo_practiceItemTwo)) {
      if (data.registrationStatus_organiserTwo_practiceItemTwo == 'option1') {
        data.registrationStatus_organiserTwo_practiceItemTwo = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemTwo == 'option2') {
        data.registrationStatus_organiserTwo_practiceItemTwo = `${i18n`field.label.partA.registrationOption2Part1`}${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserTwo_practiceItemTwo == 'option3') {
        data.registrationStatus_organiserTwo_practiceItemTwo = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemTwo == 'option4') {
        data.registrationStatus_organiserTwo_practiceItemTwo = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join2_practiceItemTwo)) {
      if (data.registrationType_join2_practiceItemTwo == 'cbo1_a') {
        data.registrationType_join2_practiceItemTwo = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join2_practiceItemTwo == 'cbo1_b') {
        data.registrationType_join2_practiceItemTwo = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join2_practiceItemTwo == 'cbo1_c') {
        data.registrationType_join2_practiceItemTwo = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join2_practiceItemTwo == 'cbo1_d') {
        data.registrationType_join2_practiceItemTwo = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_d_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join2_practiceItemTwo} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }

    if (!isEmpty(data.joinThree)) {
      if (data.joinThree == 'y') {
        data.joinThree = i18n`field.label.partA.y`;
      } else if (data.joinThree == 'n') {
        data.joinThree = i18n`field.label.partA.n`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserOne_practiceItemThree)) {
      if (data.registrationStatus_organiserOne_practiceItemThree == 'option1') {
        data.registrationStatus_organiserOne_practiceItemThree = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserOne_practiceItemThree == 'option2') {
        data.registrationStatus_organiserOne_practiceItemThree = `${i18n`field.label.partA.registrationOption2Part1`}${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserOne_practiceItemThree == 'option3') {
        data.registrationStatus_organiserOne_practiceItemThree = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserOne_practiceItemThree == 'option4') {
        data.registrationStatus_organiserOne_practiceItemThree = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join1_practiceItemThree)) {
      if (data.registrationType_join1_practiceItemThree == 'cbo1_a') {
        data.registrationType_join1_practiceItemThree = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join1_practiceItemThree == 'cbo1_b') {
        data.registrationType_join1_practiceItemThree = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join1_practiceItemThree == 'cbo1_c') {
        data.registrationType_join1_practiceItemThree = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join1_practiceItemThree == 'cbo1_d') {
        data.registrationType_join1_practiceItemThree = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_d_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join1_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserTwo_practiceItemThree)) {
      if (data.registrationStatus_organiserTwo_practiceItemThree == 'option1') {
        data.registrationStatus_organiserTwo_practiceItemThree = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemThree == 'option2') {
        data.registrationStatus_organiserTwo_practiceItemThree = `${i18n`field.label.partA.registrationOption2Part1`}${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserTwo_practiceItemThree == 'option3') {
        data.registrationStatus_organiserTwo_practiceItemThree = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemThree == 'option4') {
        data.registrationStatus_organiserTwo_practiceItemThree = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join2_practiceItemThree)) {
      if (data.registrationType_join2_practiceItemThree == 'cbo1_a') {
        data.registrationType_join2_practiceItemThree = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join2_practiceItemThree == 'cbo1_b') {
        data.registrationType_join2_practiceItemThree = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join2_practiceItemThree == 'cbo1_c') {
        data.registrationType_join2_practiceItemThree = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join2_practiceItemThree == 'cbo1_d') {
        data.registrationType_join2_practiceItemThree = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_d_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join2_practiceItemThree} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }

    if (!isEmpty(data.joinFour)) {
      if (data.joinFour == 'y') {
        data.joinFour = i18n`field.label.partA.y`;
      } else if (data.joinFour == 'n') {
        data.joinFour = i18n`field.label.partA.n`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserOne_practiceItemFour)) {
      if (data.registrationStatus_organiserOne_practiceItemFour == 'option1') {
        data.registrationStatus_organiserOne_practiceItemFour = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserOne_practiceItemFour == 'option2') {
        data.registrationStatus_organiserOne_practiceItemFour = `${i18n`field.label.partA.registrationOption2Part1`} ${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserOne_practiceItemFour == 'option3') {
        data.registrationStatus_organiserOne_practiceItemFour = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserOne_practiceItemFour == 'option4') {
        data.registrationStatus_organiserOne_practiceItemFour = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join1_practiceItemFour)) {
      if (data.registrationType_join1_practiceItemFour == 'cbo1_a') {
        data.registrationType_join1_practiceItemFour = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join1_practiceItemFour == 'cbo1_b') {
        data.registrationType_join1_practiceItemFour = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join1_practiceItemFour == 'cbo1_c') {
        data.registrationType_join1_practiceItemFour = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join1_practiceItemFour == 'cbo1_d') {
        data.registrationType_join1_practiceItemFour = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_d_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join1_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserTwo_practiceItemFour)) {
      if (data.registrationStatus_organiserTwo_practiceItemFour == 'option1') {
        data.registrationStatus_organiserTwo_practiceItemFour = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemFour == 'option2') {
        data.registrationStatus_organiserTwo_practiceItemFour = `${i18n`field.label.partA.registrationOption2Part1`} ${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserTwo_practiceItemFour == 'option3') {
        data.registrationStatus_organiserTwo_practiceItemFour = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemFour == 'option4') {
        data.registrationStatus_organiserTwo_practiceItemFour = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join2_practiceItemFour)) {
      if (data.registrationType_join2_practiceItemFour == 'cbo1_a') {
        data.registrationType_join2_practiceItemFour = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join2_practiceItemFour == 'cbo1_b') {
        data.registrationType_join2_practiceItemFour = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join2_practiceItemFour == 'cbo1_c') {
        data.registrationType_join2_practiceItemFour = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join2_practiceItemFour == 'cbo1_d') {
        data.registrationType_join2_practiceItemFour = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_c_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join2_practiceItemFour} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }

    if (!isEmpty(data.joinFive)) {
      if (data.joinFive == 'y') {
        data.joinFive = i18n`field.label.partA.y`;
      } else if (data.joinFive == 'n') {
        data.joinFive = i18n`field.label.partA.n`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserOne_practiceItemFive)) {
      if (data.registrationStatus_organiserOne_practiceItemFive == 'option1') {
        data.registrationStatus_organiserOne_practiceItemFive = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserOne_practiceItemFive == 'option2') {
        data.registrationStatus_organiserOne_practiceItemFive = `${i18n`field.label.partA.registrationOption2Part1`} ${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserOne_practiceItemFive == 'option3') {
        data.registrationStatus_organiserOne_practiceItemFive = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserOne_practiceItemFive == 'option4') {
        data.registrationStatus_organiserOne_practiceItemFive = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join1_practiceItemFive)) {
      if (data.registrationType_join1_practiceItemFive == 'cbo1_a') {
        data.registrationType_join1_practiceItemFive = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join1_practiceItemFive == 'cbo1_b') {
        data.registrationType_join1_practiceItemFive = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join1_practiceItemFive == 'cbo1_c') {
        data.registrationType_join1_practiceItemFive = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join1_practiceItemFive == 'cbo1_d') {
        data.registrationType_join1_practiceItemFive = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_d_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join1_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }

    if (!isEmpty(data.registrationStatus_organiserTwo_practiceItemFive)) {
      if (data.registrationStatus_organiserTwo_practiceItemFive == 'option1') {
        data.registrationStatus_organiserTwo_practiceItemFive = i18n`field.label.partA.registrationOption1a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemFive == 'option2') {
        data.registrationStatus_organiserTwo_practiceItemFive = `${i18n`field.label.partA.registrationOption2Part1`} ${i18n`field.label.partA.registrationOption2Part2`}`;
      } else if (data.registrationStatus_organiserTwo_practiceItemFive == 'option3') {
        data.registrationStatus_organiserTwo_practiceItemFive = i18n`field.label.partA.registrationOption3a`;
      } else if (data.registrationStatus_organiserTwo_practiceItemFive == 'option4') {
        data.registrationStatus_organiserTwo_practiceItemFive = i18n`field.label.partA.registrationOption4a`;
      }
    }

    if (!isEmpty(data.registrationType_join2_practiceItemFive)) {
      if (data.registrationType_join2_practiceItemFive == 'cbo1_a') {
        data.registrationType_join2_practiceItemFive = i18n`field.label.partA.cbo1_a`;
      } else if (data.registrationType_join2_practiceItemFive == 'cbo1_b') {
        data.registrationType_join2_practiceItemFive = i18n`field.label.partA.cbo1_b`;
      } else if (data.registrationType_join2_practiceItemFive == 'cbo1_c') {
        data.registrationType_join2_practiceItemFive = i18n`field.label.partA.cbo1_c`;
      } else if (data.registrationType_join2_practiceItemFive == 'cbo1_d') {
        data.registrationType_join2_practiceItemFive = `${i18n`field.label.partA.cbo1_d_Part1`} ${data.cbo1_d_input1_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_d_Part2`} ${data.cbo1_d_input2_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_d_Part3`} ${i18n`field.label.partA.cbo1_b_Part1`} ${data.cbo1_d_input3_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part2`} ${data.cbo1_d_input4_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part3`} ${data.cbo1_d_input5_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part4`} ${data.cbo1_d_input6_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part5`} ${data.cbo1_d_input7_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part6`} ${data.cbo1_d_input8_join2_practiceItemFive} ${i18n`field.label.partA.cbo1_b_Part7`}`;
      }
    }
    ...
    if (!isEmpty(data.itemRepOneTitle_joinOne)) {
      if (data.itemRepOneTitle_joinOne == 'mr') {
        data.itemRepOneTitle_joinOne = i18n`field.label.partF.mr`;
      } else if (data.itemRepOneTitle_joinOne == 'ms') {
        data.itemRepOneTitle_joinOne = i18n`field.label.partF.ms`;
      }
    }

    if (!isEmpty(data.itemRepOneTitle_joinTwo)) {
      if (data.itemRepOneTitle_joinTwo == 'mr') {
        data.itemRepOneTitle_joinTwo = i18n`field.label.partF.mr`;
      } else if (data.itemRepOneTitle_joinTwo == 'ms') {
        data.itemRepOneTitle_joinTwo = i18n`field.label.partF.ms`;
      }
    }
    ...
    if (!isEmpty(data.itemRepTwoTitle_joinOne)) {
      if (data.itemRepTwoTitle_joinOne == 'mr') {
        data.itemRepTwoTitle_joinOne = i18n`field.label.partF.mr`;
      } else if (data.itemRepTwoTitle_joinOne == 'ms') {
        data.itemRepTwoTitle_joinOne = i18n`field.label.partF.ms`;
      }
    }

    if (!isEmpty(data.itemRepTwoTitle_joinTwo)) {
      if (data.itemRepTwoTitle_joinTwo == 'mr') {
        data.itemRepTwoTitle_joinTwo = i18n`field.label.partF.mr`;
      } else if (data.itemRepTwoTitle_joinTwo == 'ms') {
        data.itemRepTwoTitle_joinTwo = i18n`field.label.partF.ms`;
      }
    }
    ...
    if (!isEmpty(data.itemRepThreeTitle_joinOne)) {
      if (data.itemRepThreeTitle_joinOne == 'mr') {
        data.itemRepThreeTitle_joinOne = i18n`field.label.partF.mr`;
      } else if (data.itemRepThreeTitle_joinOne == 'ms') {
        data.itemRepThreeTitle_joinOne = i18n`field.label.partF.ms`;
      }
    }

    if (!isEmpty(data.itemRepThreeTitle_joinTwo)) {
      if (data.itemRepThreeTitle_joinTwo == 'mr') {
        data.itemRepThreeTitle_joinTwo = i18n`field.label.partF.mr`;
      } else if (data.itemRepThreeTitle_joinTwo == 'ms') {
        data.itemRepThreeTitle_joinTwo = i18n`field.label.partF.ms`;
      }
    }
    ...
    if (!isEmpty(data.itemRepFourTitle_joinOne)) {
      if (data.itemRepFourTitle_joinOne == 'mr') {
        data.itemRepFourTitle_joinOne = i18n`field.label.partF.mr`;
      } else if (data.itemRepFourTitle_joinOne == 'ms') {
        data.itemRepFourTitle_joinOne = i18n`field.label.partF.ms`;
      }
    }

    if (!isEmpty(data.itemRepFourTitle_joinTwo)) {
      if (data.itemRepFourTitle_joinTwo == 'mr') {
        data.itemRepFourTitle_joinTwo = i18n`field.label.partF.mr`;
      } else if (data.itemRepFourTitle_joinTwo == 'ms') {
        data.itemRepFourTitle_joinTwo = i18n`field.label.partF.ms`;
      }
    }
    ...
    if (!isEmpty(data.itemRepFiveTitle_joinOne)) {
      if (data.itemRepFiveTitle_joinOne == 'mr') {
        data.itemRepFiveTitle_joinOne = i18n`field.label.partF.mr`;
      } else if (data.itemRepFiveTitle_joinOne == 'ms') {
        data.itemRepFiveTitle_joinOne = i18n`field.label.partF.ms`;
      }
    }

    if (!isEmpty(data.itemRepFiveTitle_joinTwo)) {
      if (data.itemRepFiveTitle_joinTwo == 'mr') {
        data.itemRepFiveTitle_joinTwo = i18n`field.label.partF.mr`;
      } else if (data.itemRepFiveTitle_joinTwo == 'ms') {
        data.itemRepFiveTitle_joinTwo = i18n`field.label.partF.ms`;
      }
    }
    ...
    if (!isEmpty(data.radiobox_1_comp)) {
      if (data.radiobox_1_comp == 'option1') {
        data.radiobox_1_comp = i18n`field.label.partA.y`;
      } else if (data.radiobox_1_comp == 'option2') {
        data.radiobox_1_comp = i18n`field.label.partA.n`;
      }
    }
...
if (!isEmpty(data.Q19iiOptionAB)) {
  if (data.Q19iiOptionAB == 'Q19iiYes') {
    data.Q19iiOptionAB = i18n`field.label.partA.beltRoadQY`;
  } else if (data.Q19iiOptionAB == 'Q19iiNo') {
    data.Q19iiOptionAB = i18n`field.label.partA.beltRoadQn`;
  }
}


if (!isEmpty(data.Q19iiiOptionAB)) {
  if (data.Q19iiiOptionAB == 'Q19iiiYes') {
...
//data.D1InternaltionExchangeHistoryFieldList.0.D1i_PreviousExchangeItem

/*if (!isEmpty(data.D1InternaltionExchangeHistoryFieldList)) {
  for (let i = 0; i < data.D1InternaltionExchangeHistoryFieldList.length; i++) {
   // if (i == 0){
      if(!isEmpty(data.D1InternaltionExchangeHistoryFieldList[i].D1i_PreviousExchangeItem) && (data.D1InternaltionExchangeHistoryFieldList[i].D1i_PreviousExchangeItem == '201718') ){
        data.D1InternaltionExchangeHistoryFieldList[i].D1i_PreviousExchangeItem = i18n`field.label.partD1iOptionA`;
      } 
    
   // }
  }
*/
/*if (!isEmpty(data.D3OtherHistoryFieldList)) {
  for (let i = 0; i < data.D3OtherHistoryFieldList.length; i++) {
      if(!isEmpty(data.D3OtherHistoryFieldList[i].D3viGovtsupport)) {

        if (data.D3OtherHistoryFieldList[i].D3viGovtsupport == 'D3viGovtsupport_y') {
          data.D3OtherHistoryFieldList[i].D3viGovtsupport.translate(i18n`field.label.partA.beltRoadQY`);
        } else if (data.D3OtherHistoryFieldList[i].D3viGovtsupport == 'D3viGovtsupport_n') {
          data.D3OtherHistoryFieldList[i].D3viGovtsupport.translate(i18n`field.label.partA.beltRoadQn`);
        }
      }
      } 
  }
...
D3viGovtsupport"
                              ...
                              options={[
                                ...
                                { value: 'D3viGovtsupport_n'D1i_PreviousExchangeItem" 
                                      label={i`field.label.partD1ititle`}
                                options={[
                                    { value: '201718', label: i`field.label.partD1iOptionA` },
