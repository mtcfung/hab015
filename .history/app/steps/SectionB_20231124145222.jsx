    ...
    {(startDateOverseas,endDateOverseas) => {
        ...
        return (
            ...
            test={(field1Value, field2Value) => {
                ...
                if (field1Value > field2Value) {
                    error = {
                        ...
                        />
              <DependsOn fields="DateAppliedInternational,numOfDay">
            {(value1 , value2) => {
                let view;
                if (value1 > value2) {
                    view = (
                        <div> 
                        <Message type="error">{i`申請資助的交流團日數不能多過自動計算的交流團日數`}</Message>
                        </div>
                        )}
                        return view;}}
            </DependsOn>
         ...
         <DependsOn fields="radiobox_1_comp">
            ...
            <DependsOn fields="DateAppliedHK,numOfDayHK">
            {(value1 , value2) => {
                let view;
                if (value1 > value2) {
                    view = (
                         ...
                         <Field.Integer name="ApplyHKnumWorkers" check={{min: 0, max:6}} required/>{i`numOfParticipants`}
                          ...
                          test={(value1, value2,value3) => {
                            ...
                            test={(field1Value, field2Value) => {
                                  ...
                                  messages={{
                                    errorHKnumwork: () => i`輸入有錯誤，請檢視及重新輸入11. 香港隨團工作人員數目或12. 申請資助的香港隨團工作人員數目。`,
                                  }}
                                />
