 ...
 <Validate fields="startDateOverseas,endDateOverseas"
    ...
    {(startDateOverseas,endDateOverseas) => {
        ...
        <Validate fields="DateAppliedInternational,numOfDay"
              test={(DateAppliedInternational,numOfDay) => {
                const errorscheckDateNumOfdays = checkDateNumOfdays(DateAppliedInternational,numOfDay)   
                let errors = {}
                errors.$ = { ...errorscheckDateNumOfdays.$,}
                if(isEmpty(errors.$))errors = {}
                return errors;
              }}
              messages={{dateValidatecheckDateNumOfdays: () => i`errors.dateValidateNumofDays`,}}
            />
         ...
         <DependsOn fields="radiobox_1_comp">
            ...
            <Validate fields="DateAppliedHK,numOfDayHK"
              test={(DateAppliedHK,numOfDayHK) => {
                const errorscheckDateNumOfdays = checkDateNumOfdays(DateAppliedHK,numOfDayHK)   
                let errors = {}
                errors.$ = { ...errorscheckDateNumOfdays.$,}
                if(isEmpty(errors.$))errors = {}
                return errors;
  ...
  <Message type="info">{<span>{i`field.label.partB.Q10Titlemessage2`}<br />{i`field.label.partB.Q10Titlemessage3`}</span>}</Message>
