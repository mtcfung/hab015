...
export default {
  convert: ({ form, submit, data }, dataTypes) => {
    ...
    data.organiserNameOne_fundingScheme=convertPartBCheckbox2strPartA(get(data,'organiserNameOne_fundingScheme',[]), i_hk);
    data.organiserNameTwo_fundingScheme=convertPartBCheckbox2strPartA(get(data,'organiserNameTwo_fundingScheme',[]), i_hk);
    data.organiserNameThree_fundingScheme=convertPartBCheckbox2strPartA(get(data,'organiserNameTwo_fundingScheme',[]), i_hk);
