...
import { Inline,Message,Field,DependsOn,PersonalInfo,Section,Validate,validation,Condition,CompositeField,FieldList,Layout,isEmpty,CustomTotalPrice,ExternalLink } from 'govhk-form-core';
...
#govhkForm th {text-align: center; !important;}`;
...
const checkDateNumOfdays = (startDate, endDate) => {
  
  const errors = {};
  if(startDate > endDate){
    errors.$ = { dateValidatecheckDateNumOfdays: true };}
  return errors;
};
...
{ /***********regiondlistOne for checking limit Q17new_AmountfromParticipants  */}
                                 
  
  const calculateQ17newAmountfromParticipantsOne = (regiondlistOne,startDateOverseas,endDateOverseas) => {
     let asia = 5;

        if (!isEmpty(regiondlistOne)) {
            if (regiondlistOne.includes('CSAmerica')|| regiondlistOne.includes('northAmerica') || regiondlistOne.includes('NZAus') || regiondlistOne.includes('northEurope') || regiondlistOne.includes('westEurope') || regiondlistOne.includes('midEastEurope') ) {
             asia = 0;  
            } else {
              asia = 1;
            }
        ...
        if(asia === 1){
          AmountLimited =  numOfDays * 1000;
          if (AmountLimited > 10000 ){
            AmountLimited = 10000;
          }
        } else if (asia === 0){
          AmountLimited =  numOfDays * 1500;
          if (AmountLimited > 20000 ){
            AmountLimited = 20000;
          }
        }
      ...
      { /***********regiondlistOne & regiondlistTwo for checking limit Q17new_AmountfromParticipants  */}
                                 
  
  const calculateQ17newAmountfromParticipantsTwo = (regiondlistOne,regiondlistTwo , startDateOverseas,endDateOverseas) => {
     let asia = 5;
        ...
        if (!isEmpty(regiondlistOne)) {
            ...
            if (!isEmpty(regiondlistTwo)) {
            if ((regiondlistOne.includes('CSAmerica')|| regiondlistOne.includes('northAmerica') || regiondlistOne.includes('NZAus') || regiondlistOne.includes('northEurope') || regiondlistOne.includes('westEurope') || regiondlistOne.includes('midEastEurope') ) || (regiondlistTwo.includes('CSAmerica') || regiondlistTwo.includes('northAmerica')|| regiondlistTwo.includes('NZAus') || regiondlistTwo.includes('northEurope') || regiondlistTwo.includes('westEurope') || regiondlistTwo.includes('midEastEurope') )) {
              asia = 0;
            } else {
              asia = 1;
             }
      ...
      { /***********regiondlistOne & regiondlistTwo & regiondlistThree for checking limit Q17new_AmountfromParticipants  */}
                                 
  
      const calculateQ17newAmountfromParticipantsThree = (regiondlistOne,regiondlistTwo , regiondlistThree , startDateOverseas,endDateOverseas) => {
         let asia = 5;
            ...
            if (!isEmpty(regiondlistThree)) {
                if ((regiondlistOne.includes('CSAmerica')|| regiondlistOne.includes('northAmerica') || regiondlistOne.includes('NZAus') || regiondlistOne.includes('northEurope') || regiondlistOne.includes('westEurope') || regiondlistOne.includes('midEastEurope') ) || (regiondlistTwo.includes('CSAmerica') || regiondlistTwo.includes('northAmerica')|| regiondlistTwo.includes('NZAus') || regiondlistTwo.includes('northEurope') || regiondlistTwo.includes('westEurope') || regiondlistTwo.includes('midEastEurope') ) || (regiondlistThree.includes('CSAmerica') || regiondlistThree.includes('northAmerica') || regiondlistThree.includes('NZAus') || regiondlistThree.includes('northEurope') || regiondlistThree.includes('westEurope') || regiondlistThree.includes('midEastEurope'))) {
                  asia = 0;
                } else {
                  asia = 1;
                }
          ...
          { /***********regiondlistOne & regiondlistTwo & regiondlistThree & regiondlistFour for checking limit Q17new_AmountfromParticipants  */}
                                 
  
      const calculateQ17newAmountfromParticipantsFour = (regiondlistOne,regiondlistTwo , regiondlistThree ,regiondlistFour,  startDateOverseas,endDateOverseas) => {
         let asia = 5;
            ...
            if (!isEmpty(regiondlistFour)) {
                if ((regiondlistOne.includes('CSAmerica')|| regiondlistOne.includes('northAmerica') || regiondlistOne.includes('NZAus') || regiondlistOne.includes('northEurope') || regiondlistOne.includes('westEurope') || regiondlistOne.includes('midEastEurope') ) || (regiondlistTwo.includes('CSAmerica') || regiondlistTwo.includes('northAmerica')|| regiondlistTwo.includes('NZAus') || regiondlistTwo.includes('northEurope') || regiondlistTwo.includes('westEurope') || regiondlistTwo.includes('midEastEurope') ) || (regiondlistThree.includes('CSAmerica') || regiondlistThree.includes('northAmerica') || regiondlistThree.includes('NZAus') || regiondlistThree.includes('northEurope') || regiondlistThree.includes('westEurope') || regiondlistThree.includes('midEastEurope')) || (regiondlistFour.includes('CSAmerica') || regiondlistFour.includes('northAmerica') || regiondlistFour.includes('NZAus') || regiondlistFour.includes('northEurope') || regiondlistFour.includes('westEurope') || regiondlistFour.includes('midEastEurope') )) {
                  asia = 0;
                } else {
                  asia = 1;
                }
          ...
          { /***********regiondlistOne & regiondlistTwo & regiondlistThree & regiondlistFour & regiondlistFive for checking limit Q17new_AmountfromParticipants  */}
                                 
  
      const calculateQ17newAmountfromParticipantsFive = (regiondlistOne,regiondlistTwo , regiondlistThree ,regiondlistFour, regiondlistFive, startDateOverseas,endDateOverseas) => {
         let asia = 5;
            ...
            { 
            if (!isEmpty(regiondlistFive)) {
                if ((regiondlistOne.includes('CSAmerica')|| regiondlistOne.includes('northAmerica') || regiondlistOne.includes('NZAus') || regiondlistOne.includes('northEurope') || regiondlistOne.includes('westEurope') || regiondlistOne.includes('midEastEurope') ) || (regiondlistTwo.includes('CSAmerica') || regiondlistTwo.includes('northAmerica')|| regiondlistTwo.includes('NZAus') || regiondlistTwo.includes('northEurope') || regiondlistTwo.includes('westEurope') || regiondlistTwo.includes('midEastEurope') ) || (regiondlistThree.includes('CSAmerica') || regiondlistThree.includes('northAmerica') || regiondlistThree.includes('NZAus') || regiondlistThree.includes('northEurope') || regiondlistThree.includes('westEurope') || regiondlistThree.includes('midEastEurope')) || (regiondlistFour.includes('CSAmerica') || regiondlistFour.includes('northAmerica') || regiondlistFour.includes('NZAus') || regiondlistFour.includes('northEurope') || regiondlistFour.includes('westEurope') || regiondlistFour.includes('midEastEurope') ) || (regiondlistFive.includes('CSAmerica') || regiondlistFive.includes('northAmerica') || regiondlistFive.includes('NZAus') || regiondlistFive.includes('northEurope') || regiondlistFive.includes('westEurope') || regiondlistFive.includes('midEastEurope') )) {
                  asia = 0;
                } else {
                  asia = 1;
                }
...
<DependsOn field="agreementUpload" >
     {(_agreementUpload_v) => {
        if (((new String(_agreementUpload_v).toString()) == (new String("no").toString()))) {
            return (
                <div>
                <Message type="info " name="message_2_comp">
                 { i`component1.message_2_comp.content.line_0` }<br/><br/>
                 </Message>
...
<DependsOn fields="InputCountryNo"> 
                                          ...
                                          view = (
                                            <div>
                                              {parseInt(value) >= 1 && 
                                                <div>
                                                  ...
                                                  optionGroups={ [
                                                    ...
                                                    <DependsOn fields="regiondlistOne">
                                                {(value) => {
                                                  let view;
                                                  if (!isEmpty(value)) {
                                                    return (
                                                  ...
                                                  options={countries(i).filter(option => !value || option.country === value)}
                                                  required />
                                                      <br/>
                                                      </div>
                                                  ...
                                                  <Field.Dropdown 
                                                    name="countryOneFake" id="countryOneFake" label={i`dropdown_countryOne.label`}
                                                    options={[
                                               ...
                                               {<DependsOn fields="countryOne,regiondlistOne">
                                                {(value,regiondlistOne) => {
                                                  let view;
                                                  ...
                                                  if (isEmpty(regiondlistOne)){ return (
                                                    <div>
                                                ...
                                                <CompositeField Layout='sentence'>
                                             <b>{i`(iii) `}{i`field.label.partA.beltRoadQ`}</b><br />
                                             ...
                                             required/>
                                              ...
                                              <DependsOn fields="regiondlistTwo">
                                                {(value) => {
                                                  let view;
                                                  if (!isEmpty(value)) {
                                                    return (
                                                  ...
                                                  <Field.Dropdown 
                                                    name="countryTwoeFake" id="countryTwoFake" label={i`dropdown_countryTwo.label`}
                                                    options={[
                                                    { value: 'y', label: i`field.label.partA.beltRoadQY` },
                                                    { value: 'n', label: i`field.label.partA.beltRoadQn` },]}
                                                    disabled={true} />
                                             ...
                                             <DependsOn fields="countryTwo,regiondlistTwo">
                                                {(value,dregiondlistTwo) => {
                                                  let view;
                                                  if (!isEmpty(value) && value.includes('othercountry')) {
                                                    return (
                                                      <div>
                                                      
                                                      <Field.Text name="othercountryNameTwo" label={i`請註明`} check={ {maxLength:20,charset:"chinese",}} size={10} required/>
                                                      
                                                      </div>
                                                      )
                                                  }
                                                 { if (isEmpty(dregiondlistTwo)){ return (
                                                    <div>
                                                  
                                                  <Field.Dropdown 
                                                    name="countryTwoFake" id="countryTwoFake" label={i`dropdown_countryTwo.label`}
                                                    options={[
                                                    { value: 'y', label: i`field.label.partA.beltRoadQY` },
                                                    { value: 'n', label: i`field.label.partA.beltRoadQn` },]}
                                                    disabled={true} />
                                                ...
                                                <CompositeField Layout='sentence'>
                                             <b>{i`(vi) `}{i`field.label.partA.beltRoadQ`}</b><br />
                                             ...
                                             required/>
                                              ...
                                              <DependsOn fields="regiondlistThree">
                                                {(value) => {
                                                  let view;
                                                  if (!isEmpty(value)) {
                                                    return (
                                                  ...
                                                  <Field.Dropdown 
                                                    name="countryThreeFake" id="countryThreeFake" label={i`dropdown_countryThree.label`}
                                                    options={[
                                                    { value: 'y', label: i`field.label.partA.beltRoadQY` },
                                                    { value: 'n', label: i`field.label.partA.beltRoadQn` },]}
                                                    disabled={true} inline/>
                                                     </div>
                                                      )
                                                ...
                                                <DependsOn fields="countryThree,regiondlistThree">
                                                {(value,regiondlistThree) => {
                                                  let view;
                                                  if (!isEmpty(value) && value.includes('othercountry')) {
                                                    return (
                                                      <div>
                                                  ...
                                                  if (isEmpty(regiondlistThree)) { return (
                                                    <div>
                                                ...
                                                <CompositeField Layout='sentence'>
                                             <b>{i`(ix) `}{i`field.label.partA.beltRoadQ`}</b><br />
                                             ...
                                             required/>
                                              ...
                                              {parseInt(value) >= 4 && 
                                                ...
                                                <DependsOn fields="regiondlistFour">
                                                {(value) => {
                                                  let view;
                                                  if (!isEmpty(value)) {
                                                    return (
                                                  ...
                                                  <Field.Dropdown 
                                                    name="countryFourFake" id="countryFourFake" label={i`dropdown_countryFour.label`}
                                                    options={[
                                                    { value: 'y', label: i`field.label.partA.beltRoadQY` },
                                                    { value: 'n', label: i`field.label.partA.beltRoadQn` },]}
                                                    disabled={true} />
                                                ...
                                                <DependsOn fields="countryFour,regiondlistFour">
                                                {(value,regiondlistFour) => {
                                                  let view;
                                                  if (!isEmpty(value) && value.includes('othercountry')) {
                                                    return (
                                                      <div>
                                                  ...
                                                  if (isEmpty(regiondlistFour)){ return (
                                                    <div>
                                                ...
                                                <CompositeField Layout='sentence'>
                                             <b>{i`(xii) `}{i`field.label.partA.beltRoadQ`}</b><br />
                                             ...
                                             required/>
                                              ...
                                              {parseInt(value) >= 5 && 
                                                ...
                                                <DependsOn fields="regiondlistFive">
                                                {(value) => {
                                                  let view;
                                                  if (!isEmpty(value)) {
                                                    return (
                                                  ...
                                                  <Field.Dropdown 
                                                    name="countryFiveFake" id="countryFiveFake" label={i`dropdown_countryFive.label`}
                                                    options={[
                                                    { value: 'y', label: i`field.label.partA.beltRoadQY` },
                                                    { value: 'n', label: i`field.label.partA.beltRoadQn` },]}
                                                    disabled={true} />
                                                ...
                                                <DependsOn fields="countryFive,regiondlistFive">
                                                {(value,regiondlistFive) => {
                                                  let view;
                                                  if (!isEmpty(value) && value.includes('othercountry')) {
                                                    return (
                                                      <div>
                                                  ...
                                                  if (isEmpty(regiondlistFive)){ return (
                                                    <div>
                                                ...
                                                <CompositeField Layout='sentence'>
                                             <b>{i`(xv) `}{i`field.label.partA.beltRoadQ`}</b><br />
          ...
          <tr>
            <th>交流團日期<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b> </th>
            <th>
            ...
            <Field.Date
              ...
              check={{
                afterToday: true,
                onOrAfter : "2025-05-01",
                onOrBefore: "2026-05-31",
               }}
               config={{ min:"2025-05-01" ,max:"2026-05-31"}}
              required
             />
 ...
 <Validate fields="startDateOverseas,endDateOverseas"
          ...
          */}
                ...
                (value) => {
                    ...
                    if (value == 'option1') {
                        ...
                        view = (
                            ...
                            check={{afterToday: true,onOrAfter : "2025-04-01",onOrBefore: "2026-05-31",}}
                            config={{ min:"5/1/2025" ,max:"05/31/2026"}}
                            required
                            />
                            <br/>{i`至`}
            ...
            <Validate fields="endDateOverseas,startDateHK"
              test={(endDateOverseas,startDateHK) => {
                const errorscheckDate = checkDate(endDateOverseas,startDateHK)   
                let errors = {}
                errors.$ = { ...errorscheckDate.$,}
                if(isEmpty(errors.$))errors = {}
                return errors;
              }}
              messages={{dateValidate: () => i`若是雙向交流項目，須先安排往海外交流的活動，然後才可舉辦訪港的活動。`,}}
            />
    ...
    {(startDateOverseas,endDateOverseas) => {
        ...
        return (
             ...
             <DependsOn fields="radiobox_1_comp">
            {
                (value) => {
                    ...
                    if (value == 'option1') {
                        view = (
                            <div>
                            <Message type="info"><b>{i`field.label.partA.OutboundMsg`}</b></Message>
          ...
          <tr>
           ...
           <div>
             <CompositeField layout="sentense">
                    {/*<Field.Integer name="DateAppliedInternational" check={{required:true,min: 0,max:'$numOfDay'}}> required</Field.Integer> {i`日`}*/}
                    
                    
                    {/*<DependsOn fields="startDateOverseas,endDateOverseas" >
                    {(startDateOverseas,endDateOverseas) => {
                        ...
                        return (
                            ...
                            <Field.Integer name="DateAppliedInternational" check={{min: 0,max:numOfDays}} messages={{ max: () => i`申請資助的交流團日數不能大於交流團日數。` }} required ></Field.Integer>{i`日`}
                                </CompositeField>
                            </div>
                        );
                    }}
                 ...
                 */}
                                   ...
                                   <Field.Integer name="DateAppliedInternational" check={{min: 0}} required ></Field.Integer>{i`日`}
                                       </CompositeField>
                                   </div>
                                  {
                                    <Validate fields="startDateOverseas,endDateOverseas,DateAppliedInternational"
                                          test={(startDateOverseas,endDateOverseas,DateAppliedInternational) => {
                                            let error;
                                      ...
                                      if (DateAppliedInternational > numOfDays) {
                                        error = {
            ...
            {/*<DependsOn fields="regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,DateAppliedInternational" >
                    {(regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,DateAppliedInternational) => {
                    
                      
                    const errorcheckday14limited = checkday14limited(regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,DateAppliedInternational);
                    let view;
                    
                    const errorcheckday21limited = checkday21limited(regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,DateAppliedInternational);
                    
                    if (!isEmpty(errorcheckday14limited) && isEmpty(Q19vSelectMultiple)){
                      
                      view = (
                    <div>
                      <br />
                        <Message type="error">{i`errors.checkday14limited`}</Message>
                        </div>
                    );
                    }

                    if (!isEmpty(errorcheckday21limited)){
                      
                      view = (
                    <div>
                      <br />
                        <Message type="error">{i`errors.checkday21limited`}</Message>
                        </div>
                    );
                    }
      ...
      { /* <Validate fields="DateAppliedInternational,numOfDay"
         ...
         { /*<Validate fields="regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,DateAppliedInternational"
           ...
           */ }
...

                {
                                ...
                                <Validate fields="regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,DateAppliedInternational"
                                test={ (regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,DateAppliedInternational) => { 
                                ...
                                {/* ((regiondlistOne.includes('japanKorea') || regiondlistOne.includes('EastsouthAsia') || regiondlistOne.includes('southAsia') || regiondlistOne.includes('midwestnorthAsia')) && (regiondlistTwo.includes('japanKorea') || regiondlistTwo.includes('EastsouthAsia') || regiondlistTwo.includes('southAsia') || regiondlistTwo.includes('midwestnorthAsia')) && (regiondlistThree.includes('japanKorea') || regiondlistThree.includes('EastsouthAsia') || regiondlistThree.includes('southAsia') || regiondlistThree.includes('midwestnorthAsia')) && (regiondlistFour.includes('japanKorea') || regiondlistFour.includes('EastsouthAsia') || regiondlistFour.includes('southAsia') || regiondlistFour.includes('midwestnorthAsia')) && (regiondlistFive.includes('japanKorea') || regiondlistFive.includes('EastsouthAsia') || regiondlistFive.includes('southAsia') || regiondlistFive.includes('midwestnorthAsia'))*/}
                                if (outOfAsia == true && !isEmpty(regiondlistOne) && (regiondlistOne.includes('japanKorea') || regiondlistOne.includes('EastsouthAsia') || regiondlistOne.includes('southAsia') || regiondlistOne.includes('midwestnorthAsia'))) {
                                default_days = 14;
                                outOfAsia = false;
                                }
                                if (outOfAsia == true && !isEmpty(regiondlistTwo) && (regiondlistOne.includes('japanKorea') || regiondlistOne.includes('EastsouthAsia') || regiondlistOne.includes('southAsia') || regiondlistOne.includes('midwestnorthAsia')) && (regiondlistTwo.includes('japanKorea') || regiondlistTwo.includes('EastsouthAsia') || regiondlistTwo.includes('southAsia') || regiondlistTwo.includes('midwestnorthAsia'))) {
                                default_days = 14;
                                outOfAsia = false;
                                }
                                if (outOfAsia == true && !isEmpty(regiondlistThree) && ((regiondlistOne.includes('japanKorea') || regiondlistOne.includes('EastsouthAsia') || regiondlistOne.includes('southAsia') || regiondlistOne.includes('midwestnorthAsia')) && (regiondlistTwo.includes('japanKorea') || regiondlistTwo.includes('EastsouthAsia') || regiondlistTwo.includes('southAsia') || regiondlistTwo.includes('midwestnorthAsia')) && (regiondlistThree.includes('japanKorea') || regiondlistThree.includes('EastsouthAsia') || regiondlistThree.includes('southAsia') || regiondlistThree.includes('midwestnorthAsia')))) {
                                default_days = 14;
                                outOfAsia = false;
                                }
                                if (outOfAsia == true && !isEmpty(regiondlistFour) && ((regiondlistOne.includes('japanKorea') || regiondlistOne.includes('EastsouthAsia') || regiondlistOne.includes('southAsia') || regiondlistOne.includes('midwestnorthAsia')) && (regiondlistTwo.includes('japanKorea') || regiondlistTwo.includes('EastsouthAsia') || regiondlistTwo.includes('southAsia') || regiondlistTwo.includes('midwestnorthAsia')) && (regiondlistThree.includes('japanKorea') || regiondlistThree.includes('EastsouthAsia') || regiondlistThree.includes('southAsia') || regiondlistThree.includes('midwestnorthAsia')) && (regiondlistFour.includes('japanKorea') || regiondlistFour.includes('EastsouthAsia') || regiondlistFour.includes('southAsia') || regiondlistFour.includes('midwestnorthAsia')))) {
                                default_days = 14;
                                outOfAsia = false;
                                }
                                if (outOfAsia == true && !isEmpty(regiondlistFive) && ((regiondlistOne.includes('japanKorea') || regiondlistOne.includes('EastsouthAsia') || regiondlistOne.includes('southAsia') || regiondlistOne.includes('midwestnorthAsia')) && (regiondlistTwo.includes('japanKorea') || regiondlistTwo.includes('EastsouthAsia') || regiondlistTwo.includes('southAsia') || regiondlistTwo.includes('midwestnorthAsia')) && (regiondlistThree.includes('japanKorea') || regiondlistThree.includes('EastsouthAsia') || regiondlistThree.includes('southAsia') || regiondlistThree.includes('midwestnorthAsia')) && (regiondlistFour.includes('japanKorea') || regiondlistFour.includes('EastsouthAsia') || regiondlistFour.includes('southAsia') || regiondlistFour.includes('midwestnorthAsia')) && (regiondlistFive.includes('japanKorea') || regiondlistFive.includes('EastsouthAsia') || regiondlistFive.includes('southAsia') || regiondlistFive.includes('midwestnorthAsia')))) {
                                default_days = 14;
                                outOfAsia = false;
                                }


                                console.log('outOfAsia '+outOfAsia);
                                console.log('DateAppliedInternational '+DateAppliedInternational);
                                console.log('default_days '+default_days);


                                if ( DateAppliedInternational > default_days && default_days == 14) {
                                error = {
                                    $: {
                                        over_default_14days_error: true,
                                    },
                                };
                                }
                                if ( DateAppliedInternational > default_days && default_days == 21) {
                                  error = {
                                      $: {
                                          over_default_21days_error: true,
                                      },
                                  };
                                  }
                                return error; } }
                                messages= { { over_default_14days_error: () => i`errors.checkday14limited`,
                                              over_default_21days_error: () => i`errors.checkday21limited`,
                                } }
                                />
         ...
         <td>
         <DependsOn fields="radiobox_1_comp,startDateHK,endDateHK">
            {
                (value,startDateHK,endDateHK) => {
                    let view;
                    if (value == 'option1') {
                        view = (
                            <div>
                      ...
                      <div>
                            <CompositeField layout="sentense">
                            <Field.Integer name="DateAppliedHK" check={{required:true,min: 2,max:numOfDaysHK}} messages={{ max: () => i`申請資助的交流團日數不能大於交流團日數。` }} required ></Field.Integer> {i`日`}
                            </CompositeField>
              ...
              <Validate
                fields="DateAppliedHK,numOfDayHK"
                test={(field1Value, field2Value) => {
                  let error;
                  if (field1Value > field2Value) {
                    error = {
            ...
            {(value) => {
                ...
                if (value > 14) {
                    view = (
                        <div> 
                        <Message type="error">{i`field.label.partB.HKExchangeOnly7days`}</Message>
                        </div>
                        )}
                        return view;}}
            </DependsOn>
  ...
  <Message type="info">{<span>{i`field.label.partB.Q10Titlemessage1`}<br />{i`field.label.partB.Q10Titlemessage1a`}<br />{i`field.label.partB.Q10Titlemessage1bi`}<br />{i`field.label.partB.Q10Titlemessage1bii`}<br />{i`field.label.partB.Q10Titlemessage1c`}<br /></span>}</Message>
  <Message type="info">{<span>{i`field.label.partB.Q10Titlemessage2`}<br />{i`field.label.partB.Q10Titlemessage2a`}<br />{i`field.label.partB.Q10Titlemessage3`}</span>}</Message>
  ...
  <table>
                ...
                <DependsOn fields="radiobox_1_comp">
            {
                (value) => {
                    ...
                    if (value == 'option1') {
                        ...
                        view = (
                            <div>
                            <CompositeField layout="sentense"><b>{i`(iv)`}</b>
                             <Field.Integer name="HKnumOfParticipants1224"  check={{min: 0,max: 30}} required /><b>{i`numOfParticipants`}</b>
                            </CompositeField>
        ...
        <th>18-35歲青年<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b></th>
                <th>
                 ...
                 <th>
                    ...
                    <div><DependsOn fields="radiobox_1_comp">
            {
                (value) => {
                    let view;
                    if (value == 'option1') {
                        ...
                        view = (
                            <div>
                            <CompositeField layout="sentense">{i`(v)`}
                             <Field.Integer name="HKnumOfParticipants2535" check={{min: 0,max: 30}} required/>{i`numOfParticipants`}
                        </CompositeField>
        ...
        <DependsOn fields="radiobox_1_comp,HKnumOfParticipants2535,HKnumOfParticipants1224">
        {(value,doHKnumOfParticipants2535,doHKnumOfParticipants1224) => {
            let view;
            let TOTALHKnumOfParticipants1235 = 0;
            TOTALHKnumOfParticipants1235 = doHKnumOfParticipants2535 + doHKnumOfParticipants1224;
            ...
            if (value == 'option1') {
              ...
              view = (
                  <div>
                  <CompositeField layout="sentense">{i`(vi)`}
        ...
        <Validate
          ...
          test={(value1, value2) => {
            ...
            if (!isEmpty(value1) && !isEmpty(value2) ) {
              ...
              error = {
                $: {
                  HKnumOfParticipantsNumberError: true,
                },
              };
            }
        }
          ...
          messages={{
            HKnumOfParticipantsNumberError: () => i`合資格參加者數目必須為1至30人。`,
          }}
        />
  ...
  {/*<Validate fields="HKnumOfParticipants1224"
                ...
                <div>
                    ...
                    {(OverseasnumOfParticipants2535,OverseasnumOfParticipants1224,HKnumOfParticipants2535,HKnumOfParticipants1224) => {
                        ...
                        if (!isEmpty(OverseasnumOfParticipants2535) && !isEmpty(OverseasnumOfParticipants1224) && !isEmpty(HKnumOfParticipants1224) && !isEmpty(HKnumOfParticipants2535) ) {
                            WholeTOTALnumOfParticipants = OverseasnumOfParticipants2535+OverseasnumOfParticipants1224+HKnumOfParticipants1224+HKnumOfParticipants2535;
                        } else {
...
{/************HknumWorker + HKsponsedWorker*/}                        
                        ...
                        {(HKnumWorkers) => {
                            ...
                            if (HKnumWorkers<1 && !isEmpty(HKnumWorkers)){
                                view = (<Message type="error">{<span>{i`field.label.partB.Q12Message`}</span>}</Message>);
                       ...
                       <div>
                         ...
                         <Field.Integer name="ApplyHKnumWorkers" check={{min: 0, max:6}} required/>{i`numOfParticipants`}
                          ...
                          <Validate fields="OverseasnumOfParticipants2535,OverseasnumOfParticipants1224,ApplyHKnumWorkers,HKnumWorkers"
                          test={(value1, value2,value3,value4) => {
                              ...
                              if (value3 > HKsponsedWorker) {
                                  error = {
                                      ...
                                      messages={{
                                        mustEqual: () => i`輸入有錯誤，請檢視及重新輸入9. 預計合資格香港參加者數目及／或12. 申請資助的香港隨團工作人員數目。`,
                                      }}
                            />
                        ...
                        <Validate fields="HKnumWorkers,ApplyHKnumWorkers"
                           test={(field1Value, field2Value) => {
                                 ...
                                 messages={{
                                    errorHKnumwork: () => i`申請資助的香港隨團工作人員數目不能多於香港隨團工作人員數目。`,
                                 }}
                                />                           
...
{/************DoubleSidenumWorker + DoubleSidesponsedWorker*/}                        
<div>
                       ...
                       <DependsOn fields="radiobox_1_comp">
                        ...
                        if (value == 'option2') {
                            view = (
                                <div>
                                <CompositeField layout="sentense">{i`field.label.partB.Q12TitleDoubleSideWorker`}<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b><br />
                                                    <Message type="info">{<span>{i`field.label.partB.Q12Titlemessage1DoubleSideWorker`}<br/>{i`field.label.partB.Q12Titlemessage2DoubleSideWorker`}<br/></span>}</Message>
                                                    <Field.Integer name="DoubleSidenumWorkers" check={{min:1}} messages={{ min: () => i`field.label.partB.Q12Titlemessage3DoubleSideWorkerMin1` }} required />{i`numOfParticipants`}
                                                </CompositeField>
                          ...
                          view = (
                            ...
                            <CompositeField layout="sentense">{i`field.label.partB.Q12TitleDoubleSideWorker`}<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b><br />
                                                {i`不適用`}
                                                <Message type="info">{<span>{i`field.label.partA.OutboundMsg`}<br/></span>}</Message>
                        ...
                        <DependsOn fields="DoubleSidenumWorkers">
                        {(DoubleSidenumWorkers) => {
                            let view;
                            if (DoubleSidenumWorkers<1 && !isEmpty(DoubleSidenumWorkers)){
                                view = (<Message type="error">{<span>{i`field.label.partB.Q12Titlemessage3DoubleSideWorkerMin`}</span>}</Message>);
                        ...
                        if (value == 'option2') {
                            view = (
                                <div>
                                                ...
                                                <CompositeField layout="sentense">
                                                 {i`field.label.partB.Q13TitleDoubleSideWorker`}<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b><br />
                        <Field.Integer name="ApplyDoubleSidenumWorkers" check={{min: 0, max:6}} required/>{i`numOfParticipants`}
                         </CompositeField>     
                          ...
                          view = (
                            <div>
                            <CompositeField layout="sentense">{i`field.label.partB.Q13TitleDoubleSideWorker`}<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b><br />
                                                {i`不適用`}
                                                <Message type="info">{<span>{i`field.label.partA.OutboundMsg`}<br/></span>}</Message>
                       ...
                       <div>
                          ...
                          <Validate fields="HKnumOfParticipants2535,HKnumOfParticipants1224,ApplyDoubleSidenumWorkers,DoubleSidenumWorkers"
                          test={(value1, value2,value3,value4) => {
                              let error;
                              let DoubleSidensponsedWorker = 0;
                              let TotalDoubleSidennumOfParticipants = value1 + value2;
                                
                                if (!isEmpty(TotalDoubleSidennumOfParticipants)){
                                if (TotalDoubleSidennumOfParticipants >= 10 && TotalDoubleSidennumOfParticipants <= 19) {
                                  DoubleSidensponsedWorker =1;
                                }
                                 else if (TotalDoubleSidennumOfParticipants >= 20 && TotalDoubleSidennumOfParticipants <= 29) {
                                  DoubleSidensponsedWorker = 2;
                                }
                                 else if (TotalDoubleSidennumOfParticipants == 30) {
                                  DoubleSidensponsedWorker = 3;    
                                }
                                }
                              

                                if (value2 >= 10 && value2 <= 19) {
                                  DoubleSidensponsedWorker = DoubleSidensponsedWorker +1;
                                   }      
                                   else if (value2 >= 20 && value2 <= 29 ) {
                                    DoubleSidensponsedWorker = DoubleSidensponsedWorker + 2;
                                }   
                                else if (value2 == 30) {
                                  DoubleSidensponsedWorker = DoubleSidensponsedWorker + 3;
                                }


                                
                              if (value3 > DoubleSidensponsedWorker) {
                                  error = {
                                    ApplyDoubleSidenumWorkers: {
                                              mustEqual: true,
                                            },
                                          };
                                        }
                                      ...
                                      messages={{
                                        mustEqual: () => i`輸入有錯誤，請檢視及重新輸入9. 預計合資格海外參加者數目及／或14. 申請資助的海外隨團工作人員數目。`,
                                      }}
                            />

                        <Validate fields="DoubleSidenumWorkers,ApplyDoubleSidenumWorkers"
                           test={(field1Value, field2Value) => {
                                   let error;
                                   if (field1Value < field2Value) {
                                     error = {
                                     ApplyDoubleSidenumWorkers: {
                                       errorDoubleSidenumwork: true,
                                      },
                                     };
                                    }
                                 ...
                                 messages={{
                                    errorDoubleSidenumwork: () => i`申請資助的海外隨團工作人員數目不能多於海外隨團工作人員數目。`,
                                 }}
                                />                           
                            
                            
                            <DependsOn fields="TOTALHKnumOfParticipants1235,HKnumOfParticipants1224,radiobox_1_comp">
                            {(value1 , value2,radiobox_1_comp) => {
                                let view;
                                let DoubleSidesponsedWorker = 0;
                                
                                if (!isEmpty(value1) || isEmpty(value2)){
                                if (value1 >= 10 && value1 <= 19) {
                                  DoubleSidesponsedWorker =1;
                                }
                                 else if (value1 >= 20 && value1 <= 29) {
                                  DoubleSidesponsedWorker = 2;
                                }
                                 else if (value1 == 30) {
                                  DoubleSidesponsedWorker = 3;    
                                }

                                
                                if (value2 >= 10 && value2 <= 19) {
                                  DoubleSidesponsedWorker = DoubleSidesponsedWorker +1;
                                   }      
                                   else if (value2 >= 20 && value2 <= 29 ) {
                                    DoubleSidesponsedWorker = DoubleSidesponsedWorker + 2;


                                }   
                                else if (value2 == 30) {
                                  DoubleSidesponsedWorker = DoubleSidesponsedWorker + 3;
                                }

                                if (radiobox_1_comp == 'option2'){
                            view = (
                                <Message type="info">{<span>{i`field.label.partB.Q13Titlemessage1DoubleSideWorker`}{`${DoubleSidesponsedWorker}`}{i`field.label.partB.Q13Titlemessage2DoubleSideWorker`}</span>}</Message>
                             )}
                            }
                             return view;
...
{/************DoubleSidenumWorker + DoubleSideponsedWorker*/}
                       
                       <div>
                         <CompositeField layout="sentense">{i`field.label.partB.Q14TitleEstimatedExpense`}<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b><br />
                         {i`港幣`}<Field.Integer name="EstimatedExpense" check={{required: true, min: 0, }} />{i`元`}
                         </CompositeField>
                        
                        <Message type="info">{i`field.label.partB.Q14MessageEstimatedExpense`}</Message>
                        ...
                        <CompositeField layout="sentense">{i`field.label.partB.Q14Title`}<b style={{ color: '#b30000', 'font-size': '16px', marginLeft: '5px' }}>*</b><br /> 
                            ...
                            {
                              <Validate fields="EstimatedExpense,ApplyAmount"
                              test={ (EstimatedExpense,ApplyAmount) => { 
                                
                          let error;
                                              
                          if ( !isEmpty(EstimatedExpense) && !isEmpty(ApplyAmount) && EstimatedExpense < ApplyAmount) {
                              error = {
                                ApplyAmount: {
                                      over_EstimatedExpense_error: true,
                                  },
                              };
                          }
                          return error; } }
                              messages= { { over_EstimatedExpense_error: () => i`申請資助額不能大於項目預算總開支。`, } }
                          />
                ...
                <div>
                         ...
                         <DependsOn fields="Q17new_AmountfromParticipantsYN,regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,startDateOverseas,endDateOverseas,InputCountryNo">
                         {(value,regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,startDateOverseas,endDateOverseas,InputCountryNo) => {
                             let view;
                             if (value == 'y') {
                              let Q15AmountLimited = 0;
                              
                              {/*console.log(regiondlistOne.value); 
                               console.log('regiondlistOne Before IF ' + regiondlistOne); 
                                console.log('regiondlistOne' + regiondlistOne.value)  console.log('regiondlistOne ' + regiondlistOne); console.log('Q15AmountLimited' + Q15AmountLimited); */}
                           if (InputCountryNo === 1 && !isEmpty(regiondlistOne) && !isEmpty(startDateOverseas) && !isEmpty(endDateOverseas) ){
                            Q15AmountLimited = calculateQ17newAmountfromParticipantsOne(regiondlistOne , startDateOverseas,endDateOverseas);
                          }
                        
                         if (InputCountryNo === 2 && !isEmpty(regiondlistOne) && !isEmpty(regiondlistTwo)  && !isEmpty(startDateOverseas) && !isEmpty(endDateOverseas) ){
                          Q15AmountLimited = calculateQ17newAmountfromParticipantsTwo(regiondlistOne , regiondlistTwo, startDateOverseas,endDateOverseas);
                        }
                      
                        if (InputCountryNo === 3 && !isEmpty(regiondlistOne) && !isEmpty(regiondlistTwo) && !isEmpty(regiondlistThree) && !isEmpty(startDateOverseas) && !isEmpty(endDateOverseas) ){
                        Q15AmountLimited = calculateQ17newAmountfromParticipantsThree(regiondlistOne , regiondlistTwo,regiondlistThree, startDateOverseas,endDateOverseas);
                      }
                      if (InputCountryNo === 4 && !isEmpty(regiondlistOne) && !isEmpty(regiondlistTwo) && !isEmpty(regiondlistThree) && !isEmpty(regiondlistFour) && !isEmpty(startDateOverseas) && !isEmpty(endDateOverseas) ){
                        Q15AmountLimited = calculateQ17newAmountfromParticipantsFour(regiondlistOne , regiondlistTwo,regiondlistThree,regiondlistFour, startDateOverseas,endDateOverseas);
                      }
                      if (InputCountryNo === 5 && !isEmpty(regiondlistOne) && !isEmpty(regiondlistTwo) && !isEmpty(regiondlistThree) && !isEmpty(regiondlistFour) && !isEmpty(regiondlistFive) && !isEmpty(startDateOverseas) && !isEmpty(endDateOverseas) ){
                        Q15AmountLimited = calculateQ17newAmountfromParticipantsFive(regiondlistOne , regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive, startDateOverseas,endDateOverseas);
                      }
                                 ...
                                 <Field.Integer name="Q17new_AmountfromParticipants"  check={{required: true, min: 1 }} messages={{ min:() =>i`如沒有收取參加者費用，請選取「不會」。`}}   />
                                  <br/><br/>
                                 <Message type="info">{<span>{i`根據第7欄填寫的目的地資料，以及第8欄填寫的交流團日數 (往海外交流團部分)，是次交流項目的參加者收費上限為港幣`}<b><u>{`${Q15AmountLimited}`}</u></b>{i`元`}</span>}</Message>
{/* Add Function   calculateQ17new_AmountfromParticipants , calculateQ17newAmountfromParticipantsTwo*/}
                       ...
                       {i`field.label.partB.Q18NEWTitle`}
                          <table>
                          <tr>
                            <th></th>
                            <th>每日收費上限</th>
                        ...
                        <DependsOn fields="Q17new_AmountfromParticipantsYN,regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,startDateOverseas,endDateOverseas,InputCountryNo,Q17new_AmountfromParticipants">
                         {(value,regiondlistOne,regiondlistTwo,regiondlistThree,regiondlistFour,regiondlistFive,startDateOverseas,endDateOverseas,InputCountryNo,Q17new_AmountfromParticipants) => {
                             let view;
                             if (value == 'y') {
                              let Q15AmountLimited = 0;
                      ...
                      if (Q17new_AmountfromParticipants > Q15AmountLimited) {
                        view = (
                                  
                          <div>
                            <br />
                            <Field.Text name="Q18new_AmountfromParticipantsMoreThan10KExplaination" label={i`field.label.partB.Q18NEWTitle1`} required check={{required: true}} messages={{ required:() =>i`輸入的參加者收費已超出上限，團體必須提供理據；或下調參加者收費。請檢視及重新輸入。`}}/>
                ...
                options={[
                 ...
                 required
                />  
                <Message type="info " name="Q19iiiDropdownOptionABC">{ i`field.label.partB.Q19ivDropdownOptionABC` }<br/></Message>
              ...
              <DependsOn fields="Q19iiiOptionAB">
                ...
                <DependsOn fields="radiobox_1_comp">
                              { (value) => {
                                let view;
                                if (!isEmpty(value) && value == 'option2' ) {
                                  view = (

                                    <div>
                                  <Field.Select name="Q19ivTitleNew2024" label={i`field.label.partB.Q19ivTitleNew2024`}
                                  required
                                  options={[
                                      { value: 'Q19ivTitleNew2024Yes', label: i`是` ,view: () => (
                                        
                                        <Layout.Inline>
                                          <br/>
                                        {i`field.label.partB.Q19ivTitleNew2024OptionA`}<br/>
                                        <Field.Integer name="Q19ivTitleNew2024OptionANumber" label={i`數量：`} size={5} check={{ required: true }}/>     
                                        <Field.Text name="Q19ivTitleNew2024OptionADName" label={i`名稱:`} size={30} check={{ required: true, maxLength: 500 }}/>  <br/><br/>

                                        
                                        
                                        <Field.Select name="Q19ivTitleNew2024ivB" label={i`field.label.partB.Q19ivTitleNew2024ivB`}
                                          required
                                          options={[
                                              { value: 'Q19ivTitleNew2024ivBYes', label: i`會` ,view: () => (
                                                <Message type="info " name="Q19ivTitleNew2024ivBYesmessage">
                                                      { i`field.label.partB.Q19ivTitleNew2024ivBYesmessageA` }<br/>
                                                      { i`field.label.partB.Q19ivTitleNew2024ivBYesmessageB` }
                                                      </Message>
                                               )},
                                              { value: 'Q19ivTitleNew2024ivBNo', label: i`否` },
                                          ]}
                                           inline
                                           required
                                          />  
                                      ...
                                      { value: 'Q19ivTitleNew2024No', label: i`否` },
                                  ]}
                                  inline
                                  required
                                  />  
                              ...
                              { (value) => {
                                ...
                                if (!isEmpty(value) && value == 'option2' ) {
                                  view = (
                                    ...
                                    <div>
                                  <Field.Text name="Q20Option2024" label={i`field.label.partB.Q20Option2024`} size={20} check={{ required: true, maxLength: 100 }}/>  <br/>
                                        </div>
                                  );
                                }
                                return view;
